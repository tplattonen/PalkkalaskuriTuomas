...
<body>
	...
	<form method="post" name="myForm" onsubmit="return validateForm()">
		...
		<input type="text" name="brutto" value="${bruttopalkka}" onkeypress='validate(event)'/> <br />
		<label>Anna nettopalkka:</label> 
		<input type="text" name="netto" value="${netto}" onkeypress='validate(event)'/> <br />
